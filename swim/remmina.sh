...
if [[ -z "`exec_container_command $container_name "which remmina"`" ]]; then
    install_container_package $container_name "remmina"
fi

exec_container_command `whoami`@$container_name "remmina"
