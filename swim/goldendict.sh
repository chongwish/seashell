...
if [[ -z "`exec_container_command $container_name "which goldendict"`" ]]; then
    install_container_package $container_name "goldendict"
fi

exec_container_command `whoami`@$container_name "goldendict"
