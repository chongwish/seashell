...
if [[ -z "`exec_container_command $container_name "which zeal"`" ]]; then
    install_container_package $container_name "zeal"
fi

exec_container_command `whoami`@$container_name "zeal"
